# -*- coding: utf-8 -*-
"""
Created on Wed May 22 23:00:07 2024
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'E:\AVM_Project\BS\dlCorners\images')
    parser.add_argument('--source_xml_path', type=str, default=r'E:\AVM_Project\BS\dlCorners\xml')
    parser.add_argument('--save_img_path', type=str, default=r'E:\AVM_Project\BS\dlCorners\dataAug\images')
    parser.add_argument('--save_xml_path', type=str, default=r'E:\AVM_Project\BS\dlCorners\dataAug\xml')
