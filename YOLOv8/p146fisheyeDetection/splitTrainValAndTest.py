# -*- coding: utf-8 -*-
"""
Created on Thu May  2 23:10:28 2024
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'E:\AVM_Project\BS\dlCorners\dataAug\images',
                        help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'E:\AVM_Project\BS\dlCorners\dataAug\txt',
                        help='txt path dir')
    parser.add_argument('--save-dir', default=r'E:\AVM_Project\BS\dlCorners\dataAug\train_val_test', type=str,
                        help='save dir')
