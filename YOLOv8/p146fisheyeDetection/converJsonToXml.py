# -*- coding: utf-8 -*-
"""
Created on Sat May 25 19:49:21 2024

@author: Andrey Liao

labelme标注的数据json文件转为labelimg格式的xml文件
...
原文链接：https://blog.csdn.net/qq_28949847/article/details/130246098
...
if __name__ == "__main__":
    '''
        目前只能支持 json中 rectangle 和 polygon 两种模式的转换，其中 polygon 的转换方式为，替换成最小外接矩形的左上角和右下角坐标
    '''
    root_json_dir = r"E:\AVM_Project\BS\dlCorners\json"
    root_save_xml_dir = r"E:\AVM_Project\BS\dlCorners\xml"
